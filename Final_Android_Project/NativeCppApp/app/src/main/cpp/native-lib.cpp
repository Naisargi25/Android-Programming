...
Java_com_ademo_nativecppapp_MainActivity_stringFromJNI(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_ademo_nativecppapp_MainActivity_sendYourName(JNIEnv *env, jobject thiz, jstring first_name,
                                                      jstring last_name) {
...
Java_com_ademo_nativecppapp_MainActivity_stringArrayFromJNI(JNIEnv *env, jobject thiz) {
