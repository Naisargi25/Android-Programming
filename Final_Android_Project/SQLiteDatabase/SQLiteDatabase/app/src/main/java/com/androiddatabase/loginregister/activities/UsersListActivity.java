...
import androiddatabase.loginregister.Task2LinearLayout;
import androiddatabase.loginregister.Task3LayoutActivity;
...
public class UsersListActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        task2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), Task2LinearLayout.class);
        ...
        task3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), Task3LayoutActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void initObjects() {
        listUsers = new ArrayList<com.androiddatabase.loginregister.model.User>();
